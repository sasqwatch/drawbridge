...
enum WINDOWS_LIBOS_FLAGS : int32_t
{
  WINDOWS_LIBOS_NORMAL = 0x0,
  WINDOWS_LIBOS_REPORT_UNHANDLED_EXCEPTIONS = 0x1,
  WINDOWS_LIBOS_REPORT_UNIMPLEMENTED_API_USAGE_DURING_BOOT = 0x2,
  WINDOWS_LIBOS_REPORT_FILE_ACCESS = 0x4,
  WINDOWS_LIBOS_REPORT_REGISTRY_ACCESS = 0x8,
  WINDOWS_LIBOS_REPORT_UNIMPLEMENTED_API_USAGE = 0x10,
  WINDOWS_LIBOS_ENABLE_FUSION_LOGGING = 0x20,
  WINDOWS_LIBOS_ENABLE_ALLOCATION_TRACKING = 0x40,
  WINDOWS_LIBOS_BUFFERED_STDOUT = 0x100,
  WINDOWS_LIBOS_BUFFERED_STDERR = 0x200,
  WINDOWS_LIBOS_FAULT_IN_REGISTRY_FROM_HOST = 0x1000,
  WINDOWS_LIBOS_DUMP_REGISTRY_ON_EXIT = 0x2000,
  WINDOWS_LIBOS_ZERO_MEMORY = 0x10000,
  WINDOWS_LIBOS_IGNORE_BINARY_PATCH_FILES = 0x20000,
  WINDOWS_LIBOS_USE_LINUX_MEMORY_MANAGER = 0x40000,
  WINDOWS_LIBOS_INHERIT_THREAD_IDS_FROM_HOST = 0x100000,
  WINDOWS_LIBOS_HOST_CPU_SUPPORTS_SSE3 = 0x200000,
  WINDOWS_LIBOS_SPAWN_IN_SAME_ADDRESS_SPACE = 0x1000000,
  WINDOWS_LIBOS_DONT_SHUTDOWN_WHEN_FIRST_APPLICATION_ENDS = 0x2000000,
  WINDOWS_LIBOS_USE_HOST_PIPES = 0x4000000,
  WINDOWS_LIBOS_ENABLE_MEMORY_PRESSURE = 0x8000000,
  WINDOWS_LIBOS_DELAY_POST_SOS_BOOT = 0x10000000,
  WINDOWS_LIBOS_DISABLE_THREAD_AFFINITY = 0x20000000,
  WINDOWS_LIBOS_DISABLE_PERSISTENT_REGISTRY = 0x40000000,
  WINDOWS_LIBOS_ALLOW_MEMORY_RESERVATION = 0x80000000,
};

enum ContainerType : int32_t
{
  CT_NONE = 0x0,
  CT_LINUX = 0x1,
  CT_WINDOWS_SERVER = 0x2,
  CT_HYPER_V = 0x3,
  CT_LAST = 0x4,
};

enum EnclaveType : int32_t
{
  WINDOWS_LIBOS_ENCLAVE_NONE = 0x0,
  WINDOWS_LIBOS_ENCLAVE_SGX = 0x1,
  WINDOWS_LIBOS_ENCLAVE_VBS = 0x2,
  WINDOWS_LIBOS_ENCLAVE_LAST = 0x3,
};

enum _HeRingBufferType : int32_t
{
  HeRingBufferType__Unknown__ = 0x0,
  HeRingBufferTypeHeSocketRingRecord = 0x1,
};
...
{
  PARAMETER_DESCRIPTOR FirstComponent;
};
...
struct _HeRingBufferInfo
{
  void *Next;
  UINT32 Id;
  HeRingBufferType Type;
  PVOID RingBuffer;
  PVOID FirstEntry;
  PUINT32 SequenceNumber;
  ULONG64 NumEntries;
  ULONG_PTR EntrySize;
  ULONG_PTR EntryDataOffset;
  ULONG_PTR EntryDataSize;
  ULONG_PTR EntryTimestampOffset;
};
